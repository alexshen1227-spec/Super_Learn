...
export const MATH_TRACKS: MathTrack[] = [
  ...
  },
  {
    id: 'hs-geo',
    name: 'Geometry (HS)',
    blurb: 'The high-school geometry year — angle arguments, triangles and the Pythagorean theorem, right-triangle trig, transformations and similarity, circles, area and volume, and proof.',
    units: [
      { name: 'Angles & parallel lines', skillIds: ['m-angles'] },
      { name: 'Triangles & the Pythagorean theorem', skillIds: ['m-triangles'] },
      { name: 'Transformations & similarity', skillIds: ['m-transform', 'm-scale'] },
      { name: 'Right-triangle trigonometry', skillIds: ['m-trig'] },
      { name: 'Circles', skillIds: ['m-circles'] },
      { name: 'Area, volume & the coordinate plane', skillIds: ['m-area', 'm-volume', 'm-coord'] },
      { name: 'Proof & argument', skillIds: ['m-proof'] },
    ],
    next: 'hs-alg2',
  },
  {
    id: 'hs-alg2',
    name: 'Algebra 2 / Precalc',
    blurb: 'Deeper functions and models — quadratics by every method, polynomials, exponentials and logarithms, sequences and series, counting, and data modeling. The bridge toward calculus.',
    units: [
      { name: 'Quadratics, mastered', skillIds: ['m-quadratic', 'm-polys'] },
      { name: 'Functions & their moves', skillIds: ['m-functions', 'm-absolute'] },
      { name: 'Exponentials & logarithms', skillIds: ['m-exponential', 'm-exponents'] },
      { name: 'Sequences & series', skillIds: ['m-sequences'] },
      { name: 'Counting & probability', skillIds: ['m-counting', 'm-prob', 'm-ev'] },
      { name: 'Data & modeling', skillIds: ['m-bestfit', 'm-variability', 'm-model'] },
    ],
    next: 'college-quant',
  },
  {
