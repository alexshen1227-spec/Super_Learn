...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    points: [
      ...
      'Separately: the maths track you pick in Settings now actually decides how hard the app aims. It always decided WHICH topics you get, but the two places that choose how high to reach were both reading the school year you typed on the first screen, and ignoring the course you said you were taking. If you are in year 7 doing Algebra I, placement was starting you three rungs down the ladder and making you climb, and the frontier was capped one rung above year 7 even though your own track teaches two rungs higher. It now reads the track first. Nothing changes if you have not picked one.',
    ],
  },
  {
    version: '8.8',
  ...
  },
  {
    ...
    points: [
      ...
      'Three more were only findable by LOOKING at the finished charts rather than measuring them. The caption said "seven values" while six dots were visible, because two people with the same answer were drawn exactly on top of each other — equal values now stack up so you can count them. The "mean" label reached across the "median" line; each label now sits beside its own line. And the dot charts kept the full height of a normal graph, leaving a large empty band above the data that read as something missing.',
    ],
  },
  {
    version: '8.1',
