    ...
    const cases = [
      {
        ...
        wrong: [
          'Genuinely stuck — the thing to do is ask for a hint now',
      ...
      },
      {
        ...
        wrong: [
          'Genuinely stuck — the thing to do is ask for a hint',
          'Productive struggle — rereading it counts as working on it',
          'Genuinely stuck — a question that you cannot even parse is simply too hard for now',
        ],
      ...
      },
      {
        ...
        why: 'Two different routes failing at the same point identifies the blocker precisely. That is the most valuable question you will ever ask, and it is much better than "I do not get any of this at all, sorry" — you can name the exact detail.',
      },
      {
        scene:
      ...
      },
      {
        ...
        wrong: [
          'Productive struggle — the thing to do is push on through it',
          'Genuinely stuck — the right thing to do is ask for a hint on this problem',
          'Genuinely stuck — you have simply lost the skill altogether',
        ],
  ...
  (rng, seed) => {
    const cases = [
      ...
      },
      {
        ...
        wrong: [
          'Take all of the hints at once so that you have the full picture',
          'Refuse the hints entirely — a hinted answer does not count',
          'Take hints until the answer appears, and then move on',
        ],
      ...
      },
      {
        ...
        wrong: [
          '"I do not get any of this at all, sorry"',
          '"Can you show me how to do this whole type of question, from the start?"',
          '"I think I am just bad at this particular topic, honestly"',
        ],
        why: 'A precise blocker gets a precise answer in thirty seconds. "I do not get any of this at all, sorry" makes them re-teach from the start, most of which you did not need. Naming where you stopped is most of the diagnostic work, and doing it is often when you unstick yourself.',
      },
      {
        scene:
        ...
        wrong: [
          'Keep going until you finally crack it — stopping now is giving up',
          'Skip it and do not come back to it; it is clearly far too hard',
          'Look up the answer and then read through it carefully',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Unfair — you did actually solve the thing in the end',
          'Meaningless — taking a hint makes the whole of that attempt worthless anyway',
          'A reason to avoid hints entirely so that your record looks better',
        ],
