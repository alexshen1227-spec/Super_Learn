  ...
  (rng, seed) => {
    const cases = [
      ...
      },
      {
        ...
        wrong: [
          'The chain is worn out and is skipping over the teeth',
          'The rear wheel is out of true and is rubbing against the frame',
          'The gears are dirty and will need cleaning before they will engage properly',
        ],
      ...
      },
      {
        ...
        wrong: [
          'You left the screen switched on all night by mistake',
          'The battery is simply old and no longer holds its charge well',
          'The charger came unplugged at some point during the night',
        ],
  ...
  (rng, seed) => {
    const cases = [
      ...
      },
      {
        ...
        wrong: [
          'B — the coordinated version explains the exact amount rather better',
          'A — because theft is fairly rare in shops generally',
          'Neither — $20 is far too small an amount to reason about',
        ],
      ...
      },
      {
        ...
        wrong: [
          'B — silence after a message usually means that something is wrong',
          'Neither — you cannot judge without asking them directly',
          'B — it accounts for the timing rather better than simple inattention does',
        ],
  ...
  (rng, seed) => {
    const cases = [
      ...
      },
      {
        ...
        wrong: [
          'Which room the plant happened to be in before this',
          'Which person has been doing the watering of it',
          'Whether the pot that it is in has any drainage holes in the bottom of it',
        ],
      ...
      },
      {
        ...
        wrong: [
          'The shoe size, and who around here owns shoes of that size',
          'How many people walked past there in total that day',
          'Whether the path is a shortcut that people around here tend to take anyway',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Which particular brand of flour was used',
          'Whether the recipe being used is a popular one with other bakers',
          'How long the baker has been baking bread for',
        ],
    ...
    const cases = [
      {
        ...
        wrong: [
          'The football broke the window, and the position of the glass proves it',
          'Nothing at all can be concluded, since any object could have broken any window',
          'A person must have thrown the ball deliberately, since the match going on nearby makes that likely enough',
        ],
      ...
      },
      {
        ...
        wrong: [
          'They copied — identical wrong answers like that are simply conclusive',
          'It is just a coincidence, since wrong answers of that kind are fairly common',
          'The teacher must have set an unfair problem, and that is the reason that both of them failed it',
        ],
      ...
      },
      {
        ...
        wrong: [
          'The strategy is what caused the loss — the timing of it shows that',
          'The strategy itself was fine; the players simply went and executed it badly on the day',
          'Nothing about a strategy can ever be judged from the results alone',
        ],
      ...
      },
      {
        ...
        correct: 'Competition is plausible, but rent, retirement, illness and lease terms end shops too — none visible from outside',
        wrong: [
          'The chain is what drove them out of business — the timing of it is perfectly clear',
          'The owner must simply have been bad at the business of running a shop like that',
          'It is completely unknowable from out here, so there is no real point in thinking about it any further',
        ],
