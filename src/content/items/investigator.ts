  ...
  (rng, seed) => {
    const cases = [
      ...
      },
      {
        ...
        wrong: ['Valid — Rex satisfies both of the statements', 'Valid — mammals and cats overlap here', 'Invalid — because Rex is obviously a dog\'s name'],
      ...
      },
      {
        ...
        wrong: ['Valid — muddy fields do prove rain', 'Valid — because rain usually does cause mud', 'Invalid — fields cannot become muddy without any grass'],
      ...
      },
      {
        ...
        wrong: ['Invalid — the alarm might well have rung quietly', 'Invalid — denying anything at all proves nothing', 'Valid only for genuinely reliable alarms'],
      ...
      },
      {
        ...
        wrong: ['Invalid — some snakes do bask to warm themselves up', 'Invalid — "no" statements can never be chained with an "all"', 'Valid only in genuinely cold climates'],
      ...
      },
      {
        ...
        wrong: ['Invalid — "some" can never yield a conclusion at all', 'Invalid — most of the students take the bus', 'Valid only if more than half of them walk'],
    ...
    const cases = [
      {
        ...
        wrong: ['Step 1 — the observations must be misremembered', 'Step 3 — it follows fine from step 2', 'Nothing at all is wrong with the argument as it stands'],
      ...
      },
      {
        ...
        wrong: ['Step 1 — athletes never actually appear in advertisements', 'Step 2 — simply restating what step 1 said is already false in itself here', 'Nothing at all is wrong with the argument as it stands'],
      ...
      },
      {
        ...
        wrong: ['Step 1 — studying never actually causes passing', 'Step 2 — intentions cannot ever appear in arguments', 'Nothing at all is wrong with the argument as it stands'],
    ...
    const cases = [
      {
        ...
        wrong: [
          'Remembering your best-ever session, which happened to have music on',
          'A friend agreeing that music helps them out as well',
          'How focused you FEEL while the music happens to be playing',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Collecting up the complaints about the new schedule',
          'Noticing that you personally feel rather more tired',
          'A poll asking all of the students whether or not they LIKE the new schedule at all',
        ],
      ...
      },
      {
        ...
        wrong: [
          'The three shots that you hit right after making the change',
          'Your coach saying that the new form looks better',
          'Feeling rather more confident at the line',
        ],
