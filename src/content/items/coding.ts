  ...
  { id: 'c-debug-boundary', name: 'Find the bug: boundary', skillIds: ['c-trace'], bucket: 'coding', difficulty: 3, minutes: 3, calibration: true },
  {
    ...
    answer: {
      ...
      options: [
        ...
        'The loop should start at i = 1 rather than at zero, or the first item is counted twice',
        'total should start at 1 rather than 0, so that the first addition lands correctly',
        'a[i] should be a[i + 1], so that the loop reads the next element instead',
      ],
      correct: 0,
    },
    hints: [
  ...
  { id: 'c-debug-logic', name: 'Find the bug: logic', skillIds: ['c-trace'], bucket: 'coding', difficulty: 3, minutes: 3 },
  {
    ...
    answer: {
      ...
      options: [
        ...
        'The condition should be a < b rather than the other way round',
        'The second return should be a instead of the value it returns',
        'Add an else branch that returns a at the end of the function',
      ],
      correct: 0,
    },
    hints: [
  ...
  { id: 'c-decompose', name: 'Decompose the task', skillIds: ['c-decomp'], bucket: 'coding', difficulty: 2, minutes: 2.5 },
  {
    ...
    answer: {
      ...
      options: [
        ...
        'One single long function that does absolutely everything in one loop, with a great many variables in it',
        'Three separate copies of the whole program, one for each of the three statistics',
        'One function per student, each of which computes all three of the statistics for that student',
      ],
      correct: 0,
    },
    hints: [
  ...
  { id: 'c-invariant', name: 'Spot the invariant', skillIds: ['c-decomp'], bucket: 'coding', difficulty: 4, minutes: 3, transfer: true },
  {
    ...
    answer: {
      ...
      options: [
        ...
        'a[w] is always zero at the top of every iteration',
        'r and w are always equal to one another at every step',
        'The array is fully sorted from the start all the way up to position r',
      ],
      correct: 0,
    },
    hints: [
