    ...
    const cases = [
      {
        ...
        wrong: [
          'They are simply excited about it and would genuinely like you to come along',
          'They are probably lying about having already told all of the other people',
          'They are being rude by assuming what your answer will be in advance of asking',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Your commitment to the group and to the goals it has agreed on',
          'Your competence at making a decision quickly when it matters',
          'Your honesty about how much you actually care about the outcome',
        ],
