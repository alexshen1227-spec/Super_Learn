    ...
    const cases = [
      {
        ...
        wrong: [
          'You — feeling fluent with the material is the clearest sign that it has been learned properly',
      ...
      },
      {
        ...
        wrong: [
          'It is all self-reported, so the app may simply be inflating the figure',
          'Percentages of this kind are meaningless without knowing how many questions there were altogether',
          'It measures speed rather than understanding, which is the thing that actually matters',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Rereading the explanation once more, to make sure that it is fully understood',
          'Writing the correct answer out several times over, so that it becomes automatic',
          'Nothing further at all — the misunderstanding has now been identified and corrected',
        ],
    ...
    const cases = [
      {
        ...
        wrong: [
          'A worked example with real numbers substituted into the rule',
          'A statement of which order the two fractions have to be written in',
          'A reminder that you should simplify the result once the multiplication has been done',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Nothing at all is wrong; this is the standard and correct account',
          'It should specify the value 9.8 m/s² in order to be complete',
          'It ignores air resistance, which is really the only reason that objects fall differently',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Your classmate explained it badly, in a way that only made sense at the actual time',
          'You were not concentrating hard enough while they were doing the speaking',
          'The topic is simply too advanced for you at your current level',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Because two negatives cancel each other out, just like in English grammar',
          'Because the rule says that multiplying two negative numbers gives you a positive',
          'Because a calculator returns a positive number whenever you try it',
        ],
    ...
    const cases = [
      {
        ...
        wrong: [
          'Two: the open window and the cold, which taken together prove carelessness',
          'One: a single description of a cold room that has an open window in it',
          'Three, and the weakest of them is the temperature, since "freezing" is clearly exaggerated',
        ],
      ...
      },
      {
        ...
        wrong: [
          'That he looked down at his phone more than twice during the conversation',
          'That the conversation lasted long enough for real boredom to develop',
          'That he has a long history of losing interest in conversations rather quickly',
        ],
      ...
      },
      {
        ...
        wrong: [
          'One of the two of them is not describing the room honestly',
          'The room itself changed in between the two visits',
          'Whichever of the two descriptions came first is the more likely to be accurate',
        ],
    ...
    const cases = [
      {
        ...
        wrong: [
          'They are simply excited about the whole thing and would genuinely like you to come along',
          'They are probably lying about having already told all of the other people about it',
          'They are being rude by assuming what your answer is going to be well in advance of even asking',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Whether the deadline they mentioned is the real one or a softer internal one',
          'Whether the other people really did a better job of it than you would have',
          'Whether you could still finish quickly enough to avoid causing the delay',
        ],
      ...
      },
      {
        ...
        wrong: [
          'You owe them something proportional, since they were the ones who helped you first',
          'You should refuse purely because the request is a good deal larger than the favour was',
          'You should accept the favour but then avoid that person entirely in future',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Your commitment to the group and to the goals that it has agreed on',
          'Your competence at making a decision quickly when it really matters',
          'Your honesty about how much you actually care about the final outcome',
        ],
