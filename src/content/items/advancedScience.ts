    ...
    const cases = [
      {
        ...
        wrong: [
          'Reading scores naturally rise every year as students get older',
          'One year is not long enough for any educational effect to appear',
          'Breakfast cannot plausibly affect reading, so the result must be an error',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Surgeons may be biased in favour of the new technique when assessing recovery',
          'The sample of patients is probably too small to detect a real difference',
          'Recovery speed is subjective and cannot be measured reliably',
        ],
    ...
    const cases = [
      {
        ...
        wrong: [
          'The sample of 18 is too small for the finding to mean anything at all',
          'Ninety minutes is too short a window for a memory effect to appear',
          'The finding is probably right but the word "improves" is too strong',
        ],
      ...
      },
      {
        ...
        wrong: [
          'A correlation of 0.2 is far too weak to be worth reporting on at all',
          'Two thousand teenagers cannot represent the whole teenage population',
          'Loneliness scores are self-reported and therefore cannot be trusted',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Three years is too short a period to judge an educational method',
          'A single school can never provide evidence about a teaching method',
          '"Doubles" is misleading because 40 to 80 is only 40 percentage points',
        ],
      ...
      },
      {
        ...
        wrong: [
          'You cannot prove a negative, so the study establishes nothing either way',
          'The study must have missed something, since screen time obviously affects schoolwork',
          'A larger sample would be needed before any conclusion could be drawn',
        ],
    ...
    const cases = [
      {
        ...
        wrong: [
          'Record how long the battery lasts each week through the winter',
          'Ask other cyclists whether their lights run down faster in winter',
          'Buy a more expensive battery and see whether the problem goes away',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Charge it fully and see how long it lasts without using it',
          'Uninstall the app you suspect and watch for a week',
          'Compare it with a friend\'s phone of the same age and model',
        ],
