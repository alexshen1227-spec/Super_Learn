    ...
    const cases = [
      {
        ...
        wrong: [
          'One plant on its own is not nearly enough to grow at all',
          'Music has to be played to them for at least a whole month',
          'Plants cannot hear anything, so the whole experiment is pointless',
        ],
      ...
      },
      {
        ...
        wrong: [
          'The colour of the cereal box that the cereal comes in',
          'The day of the week on which the cereal gets eaten',
          'The font that was used in the advertisement',
        ],
    ...
    const cases = [
      {
        ...
        wrong: [
          'The claim is right: the second bar is visibly 9 times taller than the first',
          'The claim is wrong, because the downloads actually fell',
          'Bar charts can never really be used to show growth of any kind',
        ],
      ...
      },
      {
        ...
        wrong: [
          'The claim is fully supported, because 69 to 75 is an increase',
          'The scores actually declined in every single year',
          'Line graphs simply cannot be used to show a trend of any kind at all',
        ],
    ...
    const cases = [
      {
        ...
        wrong: [
          'The 900 students — the size of a school is impossible to pin down reliably',
          'The 180 days — the length of a school year is a very well-known number',
          'The multiplication itself — the arithmetic is the step that usually goes wrong',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Look up the exact number of registered dentists actually working in that city',
          'Nothing at all — 50 sounds like a perfectly reasonable number to be using here',
          'Check whether 500,000 is really the correct population figure for that particular city',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Reject it outright — a battery obviously cannot lift something that heavy',
          'Accept it — phone batteries are surprisingly powerful for their size',
          'Search online for somebody who has actually tried the experiment already',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Musicians are hard to count, so a number like this cannot be checked',
          'Divide it by the number of concert venues there are in the country',
          'The number is far too round to have come from a real measurement',
        ],
      ...
      },
      {
        ...
        wrong: [
          'The division has been carried out the wrong way round entirely',
          '60 mph is much too slow a speed to be assuming for driving on the highway',
          'Distances measured on maps are essentially always underestimates of the real thing',
        ],
      ...
      },
      {
        ...
        wrong: [
          'The average of the two, about 254,000, is the best answer to go with',
          'The larger estimate is always the safer one, so that is the one to use',
          'Estimation simply does not work at all for a quantity of this kind',
        ],
    ...
    const cases = [
      {
        ...
        wrong: [
          'A risk that doubles like that always means a large danger in practice',
          'The study must be fraudulent for a jump of that size to appear at all',
          'Absolute risk and relative risk are really just two names for the very same thing',
        ],
      ...
      },
      {
        ...
        wrong: [
          'A figure as high as 90% is statistically impossible to obtain here',
          'Five-star rating scales are simply not allowed in surveys of this kind',
          'The sample is perfectly fine, as long as it turns out to be large enough',
        ],
      ...
      },
      {
        ...
        wrong: [
          'It rose 4% — percentage points and percent mean the same thing',
          'It rose 44%',
          'It rose 0.4%',
        ],
      ...
      },
      {
        ...
        wrong: [
          'On the wings and the tails, which is exactly where the bullet holes cluster',
          'Spread evenly over the whole plane, since the data cannot really help us here',
          'Nowhere at all — adding any more armour just slows the planes down and helps nobody',
        ],
  ...
  { id: 's-claim-strength', name: 'Claim vs evidence strength', skillIds: ['s-hypo'], bucket: 'science', difficulty: 2, minutes: 2.5, transfer: true },
  {
    ...
    answer: {
      ...
      options: [
        ...
        'Fertilizer X makes all plants everywhere grow noticeably taller than before',
        'Fertilizer X is the best fertilizer that is available anywhere',
        'Everyone growing anything at all should switch to fertilizer X immediately',
      ],
      correct: 0,
    },
    hints: [
