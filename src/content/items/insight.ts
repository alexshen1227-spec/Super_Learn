    ...
    const cases = [
      {
        ...
        wrong: [
          'A neutral reminder that the window closes soon',
          'A personalised recommendation from real data',
          'A standard legal disclosure of the terms',
        ],
      ...
      },
      {
        ...
        wrong: [
          'A sincere compliment with no strings attached to it',
          'A fair trade where both people gain something',
          'Constructive feedback about your recent progress',
        ],
      ...
      },
      {
        ...
        wrong: [
          'A generous free offer they expect you to keep',
          'A standard security measure on the account itself',
          'A misprint nobody has got round to correcting',
        ],
    ...
    const cases = [
      {
        ...
        wrong: [
          '"Fine, but this is the ABSOLUTE last time I do it" (again, as usual)',
          'Silently write out two versions, with a few mistakes left in theirs',
          'Tell everyone else in the class about it, so that they put pressure on your friend for you',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Apologize for not replying sooner and start replying faster from now on, so that they calm down and stop sending the messages',
          'Keep it a secret exactly as they asked you to, since it is probably fine and telling anybody would only make the situation more awkward',
          'Handle the whole thing on your own by arguing back with them until they get bored, lose interest, and eventually decide to leave you alone',
        ],
    ...
    const cases = [
      {
        ...
        wrong: [
          'Return fire by bringing up their worst missed deadline',
          'Walk out of the meeting in the middle of a sentence',
          'Absorb it all silently, say nothing at all, and seethe quietly for the rest of the whole project',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Match their volume exactly so that they learn how it feels',
          '"Calm down, would you — it is literally just a game"',
          'List out every single time that they have broken something of YOURS in the past year',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Craft the perfect devastating comeback, then wait for exactly the right moment to go and post it',
          'Screenshot it and send it on to a bigger account to shame them',
          'Post an angry story of your own about "some people"',
        ],
    ...
    const cases = [
      {
        ...
        wrong: [
          'Wait and see whether anything actually happens tomorrow',
          'Confront the classmate yourself, to look out for the younger kid',
          'Post the screenshots publicly so that everyone knows exactly what it was that was said',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Keep their trust by telling absolutely no one about any of it, because that is clearly what they would want you to do',
          'Assume that it is a phase which more or less everyone goes through at that age, and that it will pass on its own before long',
          'Send them some encouraging messages and quotes over the next few days, and then check back in with them again at some point next week to see how they are',
        ],
