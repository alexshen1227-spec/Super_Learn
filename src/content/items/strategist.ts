    ...
    const cases = [
      {
        ...
        wrong: ['Nothing — studying anything at all is free, whichever subject you pick', 'One hour of clock time, measured the same way for any activity', 'The history knowledge you gained from the hour you actually spent'],
      ...
      },
      {
        ...
        wrong: ['Nothing at all, because no money actually leaves your own pocket', '$10, the face value printed on the front of the gift card', '45 minutes is not a cost at all, since you were not working then anyway'],
      ...
      },
      {
        ...
        wrong: ['The 3 weeks already invested, which must not be allowed to go to waste', 'Whoever argued loudest for staying at the current level of play', 'The value of finishing everything you start, taken as a general rule'],
    ...
    const cases = [
      {
        ...
        wrong: [
          'Abandon the whole study plan now, on the grounds that it is already broken beyond repair',
          'Change nothing about the remaining nights and hope that night five somehow stretches to fit',
          'Stay up through most of the night so that the original schedule survives exactly as written',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Quietly do the whole poster yourself, say nothing about it, and carry the resentment to the end',
          'Report the partner to the teacher straight away, without raising any of it with them first',
          'Keep the original poster plan exactly as agreed and assume the partner will change their mind in time',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Pack everything up and cancel the rest of the sale, since the weather has made the plan unworkable',
          'Keep selling out in the rain exactly where you are, because the group agreed to this plan already',
          'Work out whose fault it is that nobody checked the forecast before committing to an outdoor spot',
        ],
  ...
  { id: 'st-schedule', name: 'Constraint Scheduler', skillIds: ['st-decomp'], bucket: 'strategist', difficulty: 3, minutes: 3.5, transfer: true },
  {
    ...
    answer: {
      ...
      options: [
        ...
        '3:30 do all 60 min of homework → 4:30 walk → arrive at 4:40 and join practice already in progress',
        '3:30 walk to the field early → wait → practice → walk → homework 4:55–5:55, but skipping the very first walk of the afternoon',
        'Homework cannot be split into two separate blocks, so practice has to be skipped this afternoon',
      ],
      correct: 0,
    },
    hints: [
    ...
    const cases = [
      {
        ...
        wrong: [
          'Tell your friend that the audition has been moved to a later time than it really has',
          'Let it be known around the cast that your friend is unreliable at rehearsals',
          'Tell the director how much you need this part, and how much it would hurt you to lose it',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Schedule the deciding conversation for a time when your main opponent is away at practice',
          'Say the teacher "prefers" your topic, even though they never said anything of the kind',
          'Repeat your own choice more loudly each round until the others simply give up',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Only ever challenge players in the hour right after their most exhausting matches',
          'Distract your opponents with table talk while their own clock is running down',
          'Avoid playing anyone rated near you who has a real chance of beating you',
        ],
    ...
    const cases = [
      {
        ...
        wrong: ['60 minutes — this particular evening genuinely feels different', '3 hours — assume the worst case every time and you are never late', '45 minutes — optimism about the time creates the speed to match it'],
      ...
      },
      {
        ...
        wrong: ['The estimate is 2 hours, so there is still a full 1-hour buffer left', 'Estimates of this kind do not really apply to creative work at all', 'Start in an hour, since a little deadline pressure sharpens the work'],
      ...
      },
      {
        ...
        wrong: ['"How long does this feel like it ought to take me tonight?"', '"What is the fastest this could possibly go if all goes well?"', '"How motivated do I actually feel about it right now?"'],
