      ...
      },
      {
        ...
        answer: {
          ...
          options: [
            ...
            `Plan B — its base fee is lower, and the base fee is the part you pay every single month`,
            `They work out equal at any level of usage, so it makes no real difference which you pick`,
            `Plan B — the higher per-movie price signals the better catalogue, which is what you are paying for`,
          ],
          correct: 0,
        },
      ...
      },
      {
        ...
        answer: {
          ...
          options: [
            ...
            'Yes — the better plan is simply the better plan for everybody who ends up using it',
            'No — friends ought to pick different plans so that they can compare them',
            'Yes — plan A has the bigger base fee, so it has to be the premium one',
          ],
          correct: 0,
        },
      ...
      parts: [
        ...
        },
        {
          ...
          answer: {
            ...
            options: [
              ...
              'Percentages measured on two different days are not comparable, because conditions are never the same',
              'The earlier figure was probably measured carelessly, so the old rate is the one to be suspicious of',
              'Free throws come down mostly to luck on the day, so no amount of shooting data will settle this',
            ],
            correct: 0,
          },
        ...
        },
        {
          ...
          answer: {
            ...
            options: [
              ...
              'Ask the teammate how confident the new routine makes them feel as they step up to shoot',
              'Watch one more full session and judge by eye whether the shooting looks noticeably better now',
        ...
        },
        {
          ...
          answer: mcq(
            ...
            [
              `${afterPct}% against ${beforePct}% — the routine clearly works, and the whole team ought to switch over to using it from now on.`,
              'One single session tells us nothing at all, so there really is nothing here that is worth following up on later.',
              `Compare your ${afterPct}% against what the team's best shooter usually manages, to find out whether the routine actually helped at all.`,
            ],
          ),
      ...
      parts: [
        ...
        },
        {
          ...
          answer: {
            ...
            options: [
              ...
              'Recalculate the average several ways and report whichever version represents the design best',
            ],
            correct: 0,
          },
        ...
        },
        {
          ...
          answer: mcq(
            ...
            [
              `Mean across the valid trials: ${meanClean}. The design flew consistently across every single attempt, so there was no trial that needed to be set aside for any reason at all.`,
              `Mean across all five recorded trials: ${meanAll}, which shows the design performs well overall and is ready to be entered into the fair without any further testing at all.`,
              `Mean across four valid trials: ${meanClean}, which proves beyond any doubt that this design is the best of all the ones our group has considered at any point this term.`,
            ],
          ),
