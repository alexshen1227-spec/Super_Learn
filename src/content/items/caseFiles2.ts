      ...
      parts: [
        ...
        },
        {
          ...
          answer: mcq(
            ...
            [
              `Mean across the valid trials: ${meanClean}. The design flew consistently across every attempt.`,
              `Mean across all five recorded trials: ${meanAll}, which shows the design performs well overall.`,
              `Mean across four valid trials: ${meanClean}, which proves this design is the best of all the ones our group considered this term.`,
            ],
          ),
