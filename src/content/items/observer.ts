...
const CHANGE_SCENES = [
  {
    ...
    wrong: ['The spoon moved over to the left-hand side', 'The newspaper was unfolded and left open', 'A sugar packet was removed from the tray'],
  },
  {
    before:
    ...
    wrong: ['The clock changed to read 3:00 instead', 'The plant moved over to the left-hand side', 'The globe was removed from the top shelf'],
  },
  {
    before:
    ...
    const cases = [
      {
        ...
        wrong: [
          'Saturday: you cannot bike all the way to a lake at exactly noon',
          'Rain pouring down all day contradicts the trails being slow',
          'Staying at the lake till dark contradicts leaving there at noon',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Sourdough cannot possibly have been baked as early as 7 am',
          'Owners do not work behind the counter at their own bakeries',
          'Bread described as fresh contradicts that same bread being sold',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Playing nine home games is impossible over one school season',
          'An overtime game cannot be lost by a margin as small as two',
          'Stands packed for all nine games contradicts a small school',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Enough balloons for a party cannot be inflated in one morning',
          'Sisters would not be planning a surprise party together at all',
          'Acting shocked is impossible for someone who was truly surprised',
        ],
    ...
    const cases = [
      {
        ...
        wrong: [
          'You think the project itself is bad and would rather restart it now',
          'You think we should work faster so the mismatched pieces get fixed',
          'You think half the team is not contributing to the work at the moment',
        ],
      ...
      },
      {
        ...
        wrong: [
          'You hate being played on defense and you blame Riley for the whole thing',
          'You think the coach has been unfair to you in how practice is arranged',
          'You are thinking about quitting the team some time in the near future',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Your mom said yes to the concert as long as you clean your room first',
          'Your mom said no to the concert because of how your grades are going',
          'You have decided not to go to the concert because it costs far too much',
        ],
      ...
      },
      {
        ...
        wrong: [
          'You have not actually started writing any part of the essay yet at all',
          'You need to find several more sources before you can start writing',
          'You want the Friday deadline moved back to a point later next week',
        ],
    ...
    const cases = [
      {
        ...
        wrong: [
          'Close observation — the speaker has clearly studied your manner',
          'A targeted claim — it is only ever true of genuinely insecure people',
          'A lucky guess — improbable, but it happens to land meaningfully',
        ],
      ...
      },
      {
        ...
        wrong: [
          'A demonstration of genuine sensitivity to the mood of the room',
          'A low-probability claim that would rarely be true of anyone present',
          'A specific personal detail that no one could reasonably have guessed',
        ],
      ...
      },
      {
        ...
        wrong: [
          'A precise observation — it tracks how your behavior has actually changed',
          'A falsifiable claim — you could check it easily and find it plainly wrong',
          'Inside knowledge — the sort of thing only a close friend would ever know',
        ],
      ...
      },
      {
        ...
        wrong: [
          'Independent confirmation — they reached the same conclusion on their own',
          'Prepared research — they had looked into your situation well beforehand',
          'Sheer coincidence — far too specific a match to have happened by chance',
        ],
    ...
    const cases = [
      {
        ...
        wrong: [
          '"Do you feel a lot smarter when you actually use it?"',
          '"It is great though, right? Everyone I know says so."',
          '"Are you planning to keep using it next term as well?"',
        ],
      ...
      },
      {
        ...
        wrong: [
          '"That is really annoying, is it not? Mine does the same thing."',
          '"Have you considered that phone batteries are just worse now?"',
          '"Does it feel to you like the battery is draining much faster than it used to?"',
        ],
      ...
      },
      {
        ...
        wrong: [
          '"Everything is expensive these days though, do you not think?"',
          '"Why do you even bother shopping at the corner shop then?"',
          '"Does it not seem to you like all the prices have doubled?"',
        ],
