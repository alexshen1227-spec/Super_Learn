  ...
  { id: 'c-debug-shadow', name: 'Find the bug: shadowing', skillIds: ['c-trace', 'c-funcs'], bucket: 'coding', difficulty: 3, minutes: 3 },
  {
    ...
    answer: {
      ...
      options: [
        ...
        'Functions in JavaScript cannot read the values of numbers that were passed to them as parameters',
        'The call to console.log runs before either of the two function calls does',
        'You cannot call the same function twice in a row like that',
      ],
      correct: 0,
    },
    hints: [
  ...
  { id: 's-sample-size', name: 'Small samples lie', skillIds: ['s-measure', 's-sources'], bucket: 'science', difficulty: 3, minutes: 2.5 },
  {
    ...
    answer: {
      ...
      options: [
        ...
        'A figure of exactly 100% is simply impossible to reach in a real study, however it was designed',
        'Chewing gum can never affect anything at all, one way or the other',
        'Studies have to have exactly 100 people in them before they count',
      ],
      correct: 0,
    },
    hints: [
  ...
  { id: 's-blinding', name: 'Placebos & blinding', skillIds: ['s-hypo', 's-measure'], bucket: 'science', difficulty: 3, minutes: 3 },
  {
    ...
    answer: {
      ...
      options: [
        ...
        'It tricks the control group, which is part of what makes the study interesting',
        'It proves that the medicine works before anybody has even tested it',
        'It makes the whole study a good deal cheaper to run',
      ],
      correct: 0,
    },
    hints: [
    ...
    const dialogues = [
      {
        ...
        parts: [
          ...
          { prompt: 'Why is Jon actually fine despite the dentist?', answer: { type: 'mcq' as const, options: ['Practice is at 5:30, after his 4:00 appointment', 'The dentist appointment was canceled today', 'He\'s skipping practice', 'The coach excused him from practice'], correct: 0 }, explanation: 'The times resolve the conflict: 4:00 dentist, 5:30 practice. Recalling WHY, not just THAT, is comprehension-grade listening.' },
