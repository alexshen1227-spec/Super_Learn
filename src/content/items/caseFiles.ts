        ...
        },
        {
          ...
          answer: {
            ...
            options: [
              ...
              'Students at the school suddenly evolved noticeably smaller stomachs than before',
              'The kitchen scale started weighing pizza differently from the way it weighs stew',
              'Waste data of this kind can never really mean anything at all',
            ],
            correct: 0,
          },
          explanation:
        ...
        },
        {
          ...
          answer: {
            ...
            options: [
              ...
              'Waste fell about 20% within each menu after the posters went up, which proves that the posters themselves are what caused the whole of the drop.',
              'Waste fell 28 kg in the weeks after the posters went up, which is a clear success for the whole campaign.',
              'The menus differ from one week to the next, so this data cannot say anything at all about the posters.',
            ],
            correct: 0,
          },
          explanation:
        ...
        },
        {
          ...
          answer: {
            ...
            options: [
              ...
              'Play on — winners never settle for a draw when a win is still available',
              'Play on — a full point is worth exactly twice what half a point is worth',
              'Flip a coin — the two options come out equivalent either way',
            ],
            correct: 0,
          },
          explanation:
        ...
        },
        {
          ...
          answer: {
            ...
            options: [
              ...
              'Forward it on to more people while asking "is this actually true??"',
              'Count up how many people are already sharing it',
              'Screenshot it into a bigger group chat for more visibility',
            ],
            correct: 0,
          },
          explanation:
        ...
        },
        {
          ...
          answer: {
            ...
            options: [
              ...
              'Nothing at all — quietly let it spread, since it is not your job to stop it',
              'The screenshot with "probably fake lol" (still forwarding it)',
              '"CONFIRMED FALSE" (when you have not actually confirmed anything at all)',
            ],
            correct: 0,
          },
          explanation:
