  ...
  [
    ...
    },
    {
      ...
      skills: [
        ...
        { id: 'i-levelk', name: 'How many steps do they take?', bucket: 'investigator', prereqs: ['i-game'], gradeBand: 9, blurb: 'Being the most rational person in the room is not the same as winning against the people in it. Aim one step past the actual crowd.' },
        { id: 'i-mixed', name: 'The mix they cannot read', bucket: 'investigator', prereqs: ['i-equilibrium'], gradeBand: 10, blurb: 'Solve for the proportion that leaves an opponent with no reason to prefer either reply — using their numbers, not yours.' },
        { id: 'i-median', name: 'Pushed to the middle', bucket: 'investigator', prereqs: ['i-equilibrium'], gradeBand: 9, blurb: 'When people pick the nearest option, rivals end up side by side and the person in the middle decides. Intensity counts for nothing.' },
        { id: 'i-credible', name: 'Would they actually do it?', bucket: 'investigator', prereqs: ['i-backward'], gradeBand: 10, blurb: 'A threat you would not carry out is an announcement. Credibility comes from having fewer options, not louder ones.' },
        { id: 'i-fairness', name: 'The offer that gets accepted', bucket: 'investigator', prereqs: ['i-game'], gradeBand: 9, blurb: 'What theory predicts people will take, and what they actually take — the gap is large, measured, and useful.' },
        { id: 'i-trust', name: 'Why strangers cooperate', bucket: 'investigator', prereqs: ['i-game'], gradeBand: 9, blurb: 'Repetition, reputation, enforcement. When one goes missing, find what replaces it before relying on anyone.' },
